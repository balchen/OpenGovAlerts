...
namespace OpenGovAlertsTests
{
    ...
    public class SyncService
    {
        ...
        public async Task Synchronize()
        {
            ...
            Observer slf = new Observer { Name = "SLF Nord-Jæren og Ryfylke", Email = "nord-jaren@syklistene.no", SmtpServer = "mail.syklistene.no", SmtpPassword = "Hverdagssykling123", SmtpSender = "nord-jaren@syklistene.no", SmtpPort = 587, SmtpUseSsl = true };
